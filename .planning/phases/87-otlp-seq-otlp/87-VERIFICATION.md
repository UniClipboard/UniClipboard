...
All 15 REQ-87-_ requirements are satisfied. REQ-87-_ were not in REQUIREMENTS.md at verification time (file ends at PH85); they are defined in `87-RESEARCH.md` and ROADMAP.md.
