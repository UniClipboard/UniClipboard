...
fn admission_stage_label(stage: &AdmissionRecoveryStageDto) -> &'static str {
    match stage {
        ...
        AdmissionRecoveryStageDto::RepositoryRecord => "membership records",
        AdmissionRecoveryStageDto::RecoverySummary => "membership summary",
        AdmissionRecoveryStageDto::Storage => "local storage",
    }
}
