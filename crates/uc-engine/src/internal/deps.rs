...
pub struct BackgroundRuntimeDeps {
    ...
    pub file_transfer_lifecycle: Arc<crate::internal::file_transfer::FileTransferLifecycle>,
...
pub struct WiredDependencies {
    ...
    /// The host's single decision on whether this process talks to the real OS
    /// clipboard. Hosts gate their clipboard-bound assembly on this.
