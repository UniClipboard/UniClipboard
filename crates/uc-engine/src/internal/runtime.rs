...
use uc_application::facade::{
    AppFacade, ClipboardHistoryError, ClipboardHostEvent, ClipboardOriginKind, FailTransfer,
    HostEvent, HostEventBus, InMemoryLifecycleStatus, ReportTransferProgress, ResourceFacadeError,
    SearchCoordinator, SearchCoordinatorDeps, SearchFacadeError, SearchPageView, SearchQueryInput,
    SeedReceiverContext, StartTransfer, MAX_INLINE_OUTBOUND_REPRESENTATION_BYTES,
};
use uc_application::facade::{
...
use uc_core::{
    ClipboardChangeOrigin, FileDisplayMetadata, FileDisplayMetadataEntry, FileTransferDirection,
    FileTransferFailureReason, FileTransferProgress, MimeType, ObservedClipboardRepresentation,
...
impl ProductionRuntime {
    ...
    async fn start_mobile_file_upload_lifecycle(
        ...
        let lifecycle = self.wired.shared.file_transfer_facade.as_ref();
        lifecycle
