...
///
/// - `@ts-nocheck` and `oxlint-disable` keep generated code out of lint checks.
/// - `oxfmt-ignore` and `.oxfmtrc.json` preserve generator output byte-for-byte.
/// - The banner directs developers to update the source and regenerate the files.
